...
if exist "C:\Users\jsmith\windows.iso" (
  move /Y C:\Users\jsmith\windows.iso C:\Windows\Temp
)
...
if exist "C:\Users\jsmith\VBoxGuestAdditions.iso" (
  move /Y C:\Users\jsmith\VBoxGuestAdditions.iso C:\Windows\Temp
)
